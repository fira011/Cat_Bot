...
cl = LINETCR.LINE()
cl.login(token='EnqHXyTmTmfsUAtjy9Jb.BThkCee70z0HnBVOuvBn6W.ocx4twSVMZGeub4rLiOHoY+6US0uLr4KlnoESuLt1A8=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token='Env8zFkBNUnx9AZIzMZa.CZgRpE2PgJOBF+NlS+sJoG.PfRgfH7aLDuz18YUrG3OlnbZ1xS0QF1dEIykQrqK8OY=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token='EnIygKdnmLbUHbZTXISb.I9YBMfRqAE5FKjP6B2coYW.V0jBIMCRPEks2x63exhQaMmB/7e1tES8GoDuLjrkcN4=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
kc.login(token='Enn5jVagSAF90NfK8Hoc.jFGC7fqRUB/KtU5LBYaMNa.bPeBYZRXnI4lcYmkkosvxdmJI5EKeuRtpxxXn193kSY=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
kr.login(token='EnMhGDcKTDOVCB9LOG52.N/RlxRz2fWJfjPHay81q4G.Rxf5lD1jB5ewe2LnxQiq/Ru8YQppmLjWVwcTpqNWYPw=')
kr.loginResult()
...
Creator="ud1d7aa3553c4d73941a2eea242cb6908"
