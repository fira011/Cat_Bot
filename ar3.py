...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EnXZ9ZiJi5RsaPtxBNk8.0DEQnvpe1ZLbOU6IqSTPca.+U2UIiJquk6tXc2oxPCCENQ+htRUvkSqn1mPLLTmhfM=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EnQ1nfw4EmZL9uWpUei2.uswj2+OcNnhQeebdZ3lRyG.Pnkl1DhhpnTJhBhOyjaV+6tlHvCYwd8/HAFDNQ4M+oY=")
ki.loginResult()

ki2 = LINETCR.LINE()
#ki2.login(qr=True)
ki2.login(token="EnmNLo60qVYNKXNwqF80.WAyfme1yf6BASHkM/2yRKa.1xsxuWhKeamjvy3PQytSMyMs4hyLpeXf5cSRu6VU1VQ=")
ki2.loginResult()

ki3 = LINETCR.LINE()
#ki3.login(qr=True)
ki3.login(token="EnL3kzz5lIxQTMvrnsld.IYRlLVGOtjG/o6fOmBBVhq./rK4txY2+FxMeAxCqp1bi1mpA12QSiH/oin0YVV+jkk=")
ki3.loginResult()

ki4 = LINETCR.LINE()
#ki4.login(qr=True)
ki4.login(token="EntTZF5DlJC11TzcSZr8.sGd5WWqmO7ZOk9A28oPlsa.EXyajaBCbwmETBfyTaxuaFgd8eVcmz5Hnb/Ug65iILA=")
ki4.loginResult()

ki5 = LINETCR.LINE()
#ki5.login(qr=True)
ki5.login(token="EndJhU4goh6AqtgOoNfb./NhWDXfXHs3T5T7YF5IHMW.KjrPNXkWQSm9eumGUU0aGeD1KJKbUZ8YeiKDV0xe9Rw=")
ki5.loginResult()
