...
cl = LINETCR.LINE()
cl.login(token="EnVsn2VAI9wiK5Ntpc7a.0ikaZF3A5tcECFODftsw2G.KAQlqERNTijRT4OStnPXQpXAFofPNgLQLmQaXG/0beY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnDeDaxr4pHSdwdghQOb.BThkCee70z0HnBVOuvBn6W.yt0dFI7AbMwMcmEyRfj7ArXzpFi2iImcwgVWS4GU/ng=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="En4eIaGRCIGhcyYfchpa.CZgRpE2PgJOBF+NlS+sJoG.fwWzDJd+fLe0fmj31aJqcTgJc/x4zfuecIiDvAWwb0o=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EnE4gDeL2I8hlTYpwRob.I9YBMfRqAE5FKjP6B2coYW.ZcIc3aC9X1pW4Zz45qKg0fksfammlDfLhyKKO43jTNQ=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Eno9A31AZgskpN0XtLmc.jFGC7fqRUB/KtU5LBYaMNa.d7FVhNYYMQ6Ll7kBj/A5spwAzzfz/fru8gCDe3mV/4E=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EnHAN5l1qJYJoEllcn92.N/RlxRz2fWJfjPHay81q4G.DLysdTbPPtIVXyzfNvNxwp3+v5wLFt9nnLAQ+L63g3I=")
ki5.loginResult()
...
╔═══════════════════
╠     ✍ PROTECT ✍️
╠❂͜͡➣[AllProtection]~[Fras on - off]
╠❂͜͡➣[Protect QR]~[Qr on - off]
╠❂͜͡➣[Mid Check]~[Contact On - Off]
╠❂͜͡➣[Reject Invite]~[Bi on - off]
╠❂͜͡➣[Protect Cancel]~[Cn on - off]
╠❂͜͡➣[Member Protect]~[M on - off]
╚═══════════════════
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"ud08280cdfddae5309e71fa1d153496da"]
admin = ["ud08280cdfddae5309e71fa1d153496da"]
staff = ["ud08280cdfddae5309e71fa1d153496da"]
adminMID = "ud08280cdfddae5309e71fa1d153496da"
wait = {
    'contact':True,
    'autoJoin':True,
            	...
            	if msg.from_ in admin or staff:
                    if wait["contact"] == True:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"done")
            elif msg.text in ["é€£çµ¡å…��:ã‚ªãƒ•","K off","Contact off","é¡¯ç¤ºï¼��é—œ"]:
            	if msg.from_ in admin or staff:
